...
<table border="1" width="100%" style="border-collapse: collapse;">
    ...
    <form method="POST" action="modules/quanlybaiviet/xuly.php?idbaiviet=<?php echo $row['id'] ?>"
        ...
        <tr>
            <td>Tóm tắt</td>
            <td><textarea rows="10" width name="tomtat" style="resize: none" <?php echo $row['tomtat'] ?>></textarea>
            </td>
        </tr>
        <tr>
            <td>Nội dung</td>
            <td><textarea rows="10" width name="noidung" style="resize: none" <?php echo $row['noidung'] ?>></textarea>
            </td>
        </tr>
        <tr>
