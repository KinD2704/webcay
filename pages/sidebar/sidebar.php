    <div class="sidebar">
        <div class="sidebar_item">
            <h4 class="title_danhmucsanpham">Danh mục sản phẩm</h4>
        ...
        <div class="sidebar_item">
            <h4 class="title_danhmucbaiviet">Danh mục ý nghĩa</h4>
            <ul class="list_sidebar">
                <?php
                ...
                ?>
                <li>
                    <a href="index.php?quanly=danhmucbaiviet&id=<?php echo $row['id_baiviet'] ?>">
